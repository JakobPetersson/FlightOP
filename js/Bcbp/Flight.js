        ...
        return (
            <Panel header={title} bsStyle="primary">
                <Form horizontal fill>
                    ...
                    <Item key={conditional.airlineNumericCode.itemNr}
                          item={conditional.airlineNumericCode}
                          dataChange={this.props.dataChange} />
                    <Item key={conditional.documentFormOrSerialNumber.itemNr}
                          item={conditional.documentFormOrSerialNumber}
                          dataChange={this.props.dataChange} />
                    <Item key={conditional.selecteeIndicator.itemNr}
                          item={conditional.selecteeIndicator}
                          dataChange={this.props.dataChange} />
                    <Item key={conditional.internationalDocumentationVerification.itemNr}
                          item={conditional.internationalDocumentationVerification}
                          dataChange={this.props.dataChange} />
                    <Item key={conditional.marketingCarrierDesignator.itemNr}
                          item={conditional.marketingCarrierDesignator}
                          dataChange={this.props.dataChange} />
                    <Item key={conditional.frequentFlyerAirlineDesignator.itemNr}
                          item={conditional.frequentFlyerAirlineDesignator}
                          dataChange={this.props.dataChange} />
                    <Item key={conditional.frequentFlyerNumber.itemNr}
                          item={conditional.frequentFlyerNumber}
                          dataChange={this.props.dataChange} />
                    <Item key={conditional.idOrAdIndicator.itemNr}
                          item={conditional.idOrAdIndicator}
                          dataChange={this.props.dataChange} />
                    <Item key={conditional.freeBaggageAllowance.itemNr}
                          item={conditional.freeBaggageAllowance}
                          dataChange={this.props.dataChange} />
                    <Item key={conditional.fastTrack.itemNr}
                          item={conditional.fastTrack}
                          dataChange={this.props.dataChange} />

                    <Item key={conditional.forIndividualAirlineUse.itemNr}
